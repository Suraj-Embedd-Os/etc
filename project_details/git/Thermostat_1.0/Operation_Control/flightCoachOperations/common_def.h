...
typedef enum
{
    ...
    FAN_ON_SYSTEM_DEHUMIDIYFY,                           // To show the operation mode 5 status, if operation mode is selected by the user
    ...
    FAN_AUTO_SYSTEM_DEHUMIDIYFY,                           // To show the operation mode 5 status, if operation mode is selected by the user
...
typedef enum
{
    ...
    FAN_ON_SYSTEM_DEHUMIDIYFY_STATUS_BIT                =(1<<FAN_ON_SYSTEM_DEHUMIDIYFY),                         
    ...
    FAN_AUTO_SYSTEM_DEHUMIDIYFY_STATUS_BIT              =(1<<FAN_AUTO_SYSTEM_DEHUMIDIYFY),                           
